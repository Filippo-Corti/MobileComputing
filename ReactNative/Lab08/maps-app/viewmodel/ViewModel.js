...
export default class ViewModel {
    ...
    async getMenuFullDetailsById(menuId, latitude, longitude) {
        ...
        try {
            ...
            const menuDetails = await APIController.getMenuDetailsById(this.sessionData.sid, menuId, latitude, longitude);
